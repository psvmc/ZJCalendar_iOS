...
-(void)setupView{
    ...
    _topView.backgroundColor=[UIColor colorWithRed:85.0/255 green:180.0/255 blue:70.0/255 alpha:1];
    _weekView.backgroundColor=[UIColor colorWithRed:85.0/255 green:180.0/255 blue:70.0/255 alpha:1];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(==0)-[selview]-(==0)-|" options:0 metrics:nil views:viewDic]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[topv]-(==0)-[selview(==162)]" options:0 metrics:nil views:viewDic]];
...
-(void)layoutSubviews{
    ...
    if(_weekView.subviews.count==0){
        ...
        _calView.layer.borderColor=[UIColor colorWithRed:0.9 green:0.9 blue:0.9 alpha:1].CGColor;
